...
MESSAGE_RECEIPT_CONFIRMED_RETENTION_DAYS = max(1, int(os.getenv("MESSAGE_RECEIPT_CONFIRMED_RETENTION_DAYS", "7")))
...
PROFILE_MEDIA_STORAGE_BACKEND = os.getenv("PROFILE_MEDIA_STORAGE_BACKEND", MEDIA_STORAGE_BACKEND).strip().lower()
